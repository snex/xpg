...
module Admin
  class WalletsController < ApplicationController
    ...
    def create
      ...
      if @wallet.save
        redirect_to admin_wallets_url, notice: t(:'wallet.created')
      else
    ...
    def update
      if @wallet.update(wallet_params)
        redirect_to admin_wallets_url, notice: t(:'wallet.updated')
      else
    ...
    def destroy
      ...
      redirect_to admin_wallets_url, notice: t(:'wallet.destroyed')
    end
